...
/* 상단 - 메인, 서브 타이틀 */
.t_title{font-family: 'Hammersmith One', sans-serif; font-size: 2.2em; text-align: center; margin:30px 0; color:#6FD262}
/* 중단 - 입력창  */
.f_input{width:450px; text-align: center; border: 1px solid #ccc; padding: 10px; border-radius: 5px; margin: 0 auto;}
